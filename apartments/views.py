...
class ApartmentList(LoginRequiredMixin, SuccessMessageMixin, generic.ListView):
    model = Apartment
...
class ApartmentDetail(LoginRequiredMixin, SuccessMessageMixin, generic.DetailView):
    model = Apartment
